...
[![License](https://img.shields.io/crates/l/enman.svg)](https://github.com/yourname/enman/blob/main/LICENSE)
...
访问 [Releases](https://github.com/yourname/enman/releases) 页面下载适合你系统的预构建二进制文件。

## GUI 安装程序

我们目前正在开发图形界面安装程序，但目前尚未完成。如果您对图形界面安装有特殊需求，请参阅 [GUI 安装程序说明](./GUI_INSTALLER_NOTE.md)。
...
enman 使用 shim 机制来拦截命令并根据全局或项目配置自动切换工具版本。所有受支持的工具命令都会通过 `~/.enman/shims` 目录中的 shim 脚本进行路由。
...
如果遇到问题，请查看 [GitHub Issues](https://github.com/yourname/enman/issues) 或提交新问题。
